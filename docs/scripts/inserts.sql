...
('Smart Tv Oled 65\" Ultra Hd 4k Lg', 'Tenha efeito e qualidade de cinema na sua casa! E não é só um modo de dizer não, a nova geração de TV OLED da LG traz literalmente qualidade de imagem e som aplicados em cinema.', 11999, 50, 'TV e Home Theater;TV;TV 4K', 5),
('Monitor Gamer Curvo Samsung Odyssey 27', 'Verifique com os fabricantes do produto e de seus componentes eventuais limitações à utilização de todos os recursos e funcionalidades.', 4550, 100, 'PC Gamer;Perifericos Gamers;Monitor Gamer', 6),
